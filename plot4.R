...
plot(electric.data$date.time, electric.data$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
...
plot(electric.data$date.time, electric.data$Global_reactive_power, type = "l", ylab = "Global_Reactive_Power", xlab = "datetime")
dev.off()